...
const styles = theme => ({
 ...
 class FormDialogUpdate extends React.Component {
  state = {
    open: false,email: this.props.personnel.email,nomPersonnel:this.props.personnel.nomPersonnel,
...
this.props.updatePersonnel(this.state)}
  ...
  render() {
    ...
    return (
      <div>
        <IconButton aria-label="Update" variant="outlined" color="primary" onClick={this.handleClickOpen}>
...
export default withRouter(
  connect(null, mapDispatchToProps) (withStyles(styles)(FormDialogUpdate)));
